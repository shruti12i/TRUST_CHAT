            ...
            <div class="container">
                ...
                <% if (offlineDelivered != null && offlineDelivered > 0) { %>
                    <div class="alert alert-success">
                        📬 <%= offlineDelivered %> offline message<%= offlineDelivered > 1 ? "s" : "" %>
                        delivered to your inbox while you were away.
                    </div>
                <% } %>
                ...
                <% if (users != null && !users.isEmpty()) { %>
                    <div class="user-list">
                        <% for (User user : users) {
                            ...
                            int userUnread = (!isStudentChat && unreadPerSender != null && unreadPerSender.containsKey(user.getUserId()))
                                             ? unreadPerSender.get(user.getUserId()) : 0;
